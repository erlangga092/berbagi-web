---
date: "2021-11-25"
title: How to use custom fonts in Tailwind CSS
description: Add custom fonts, including web fonts and locally installed fonts, to your Tailwind projects to improve UI design.
prerequisites:
    [
