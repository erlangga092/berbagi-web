---
date: "2021-11-25"
title: A complete guide to Flutter architecture
description: Learn about Flutter's architecture to help when structuring an app, updating state, building widgets or screens, and maintaining
prerequisites:
    [
